...
function themeConfig($form)  {
    ...
    $siteIcon = new Typecho_Widget_Helper_Form_Element_Text('siteIcon', NULL,  _t('/usr/themes/typecho_material_theme/img/favicon.ico'), _t('标题栏和书签栏 Icon'), _t('在这里填入一个图片URL, 作为标题栏和书签栏 Icon, 默认不显示'));
